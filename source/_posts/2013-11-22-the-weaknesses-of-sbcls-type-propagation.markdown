...
1. lexical variable V is (is not) of type T at this program point
...
A weaker form of this change would be to use preliminary (perhaps
...
The only suggestion to accelerate constraint propagation so far is to
